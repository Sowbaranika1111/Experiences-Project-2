...
class MenuDrawer extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Drawer(
      child : ListView(
        children: buildMenuItems(context) //the context is the same as BuildContext , which we recieve whenthe build method gets called
  ...
  List<Widget> buildMenuItems(BuildContext context){
    ...
    menuItems.add(const DrawerHeader(
      ...
      child: Text('"When we share our stories, what it does is, it opens up our hearts for other people to share their stories. And it gives us the sense that we are not alone on this journey."\n - Janine Shepherd',
